                ...
                {messages.length === 0 ? (
                    ...
                    (() => {
                        ...
                        messageGroups.forEach((group, gIndex) => {
                            ...
                            elements.push(<MessageGroup key={`group-${gIndex}`} sender={group.sender} messages={group.messages} fromCurrentUser={fromCurrentUser} onReply={handleReply} onOpenThread={openThread} />)
