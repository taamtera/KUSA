    ...
    return (
        <div className="w-full">
            <div className="pt-60 pl-4 mb-6 p-12 md:p-14 lg:p-16 xl:p-18">
                <div className="text-8xl text-center font-serif">KUSA</div>
                <div
                ...
                <div className="flex justify-center" style={{ marginTop: 2 + "cm" }}></div>
                <div className="flex justify-center" style={{ marginTop: 2 + "cm" }}>
                    <div class="grid grid-flow-row grid-rows-7 grid-cols-20 gap-2 overflow-x-auto">
                        <div class="bg-amber-50 col-span-2 p-4 w-30 text-center">01</div>
                        <div class="bg-amber-100 col-span-2 p-4 w-30 text-center">02</div>
                        <div class="bg-amber-200 col-span-2 p-4 w-30 text-center">03</div>
                        <div class="bg-amber-300 col-span-2 p-4 w-30 text-center">04</div>
                        <div class="bg-amber-400 col-span-2 p-4 w-30 text-center">04</div>
                        <div class="bg-amber-500 col-span-2 p-4 w-30 text-center">04</div>
                        <div class="bg-amber-600 col-span-2 p-4 w-30 text-center">04</div>
                        <div class="bg-amber-700 col-span-2 p-4 w-30 text-center">04</div>
                        <div class="bg-amber-800 col-span-2 p-4 w-30 text-center">04</div>
                        <div class="bg-amber-900 col-span-2 p-4 w-30 text-center">04</div>
                        <div class="bg-blue-50 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-100 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-200 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-300 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-400 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-500 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-600 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-700 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-800 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-900 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-50 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-100 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-200 col-span-2 p-4 w-30 text-center"></div>
                        <div class="bg-blue-300 col-span-2 p-4 w-30 text-center"></div>
